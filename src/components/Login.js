...
export default function Login() {
  ...
  return (
    <div className="rightside" style={{ backgroundColor: "purple" }}>
      ...
      >
        Welcome to FX Tracker
      </h4>
      <div className="login__box">
        <Form onSubmit={handleSubmit} className="a__form">
          <h3>Log in</h3>
          <FormGroup className="form-group">
            <Label htmlFor="username" className="spacing__text">
              Username
            </Label>
            <Input
              type="text"
          ...
          <FormGroup className="form-group">
            <Label htmlFor="password" className="spacing__text">
              Password
            </Label>
            <Input
              type="password"
          ...
          <p
            style={{ textAlign: "right", fontWeight: 500, fontSize: "1.5rem" }}
          >
